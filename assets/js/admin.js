...
const SITE_COPY_GROUPS = [
  ...
  },
  {
    ...
    description: "This covers the homepage services heading and intro beneath the hero.",
    fields: [
  ...
  {
    id: "copy-feedback",
    eyebrow: "Feedback page",
    title: "Feedback page copy",
    description: "These fields control the feedback page intro, sidebar details, and the review-strip copy reused on Trust & Process.",
    fields: [
      { name: "feedbackEyebrow", label: "Page eyebrow" },
      { name: "feedbackTitle", label: "Page title", type: "textarea", wide: true, rows: 2 },
      { name: "feedbackLead", label: "Page lead", type: "textarea", wide: true, rows: 4 },
      { name: "feedbackSourceLabel", label: "Review source label" },
      { name: "feedbackSourceValue", label: "Review source value", type: "textarea", wide: true, rows: 2 },
      { name: "feedbackProfileLabel", label: "External profile label" },
      { name: "feedbackProfileValue", label: "External profile value" },
      { name: "feedbackThemesLabel", label: "Common themes label" },
      { name: "feedbackThemesValue", label: "Common themes value", type: "textarea", wide: true, rows: 3 },
      { name: "testimonialsEyebrow", label: "Reviews section eyebrow" },
      { name: "testimonialsTitle", label: "Reviews section title", type: "textarea", wide: true, rows: 2 },
      { name: "testimonialsLead", label: "Reviews section lead", type: "textarea", wide: true, rows: 4 },
      { name: "testimonialsBadgeLabel", label: "Reviews count label" },
    ],
  },
  {
